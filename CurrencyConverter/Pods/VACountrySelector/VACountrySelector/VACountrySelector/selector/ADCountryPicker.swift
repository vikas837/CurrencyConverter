...
open class ADCountryPicker: UITableViewController {
    ...
    fileprivate var unsortedCountries : [ADCountry] {
       ...
       // var countriesCodes = customCountriesCode == nil ? Locale.isoRegionCodes : customCountriesCode!
        
        let countriesCodes = ["AD", "AS", "AT", "AU", "AX", "BE", "BG", "BR", "BV", "IO", "VG", "BQ", "CA", "CC", "CK", "CN", "CX", "CY", "CZ", "EA", "HR", "IC", "DG", "DK", "EC", "EE", "SV", "FI", "FO", "FR", "GF", "TF", "DE", "GL", "GP", "GB", "GR", "GU", "HK", "HM", "HU", "ID", "IE", "IL", "IN", "IQ", "IS", "IT", "JP", "KI", "XK", "LI", "LS", "LT", "LU", "LV", "FM", "MC", "ME", "MH", "MQ", "MT", "MX", "MY", "YT", "MP", "NF", "NL", "NO", "NR", "NU", "NZ", "PH", "PL", "PN", "PR", "PS", "PT", "PW", "RE", "RO", "BL", "CH", "ES", "KR", "MF", "PM", "SE", "SG", "SI", "SJ", "SK", "SM", "ZA", "TC", "TH", "TK", "TL", "TR", "TV", "UM", "US", "VI", "VA", "ZW"]
    ...
    public func getFlag(countryCode: String) -> UIImage? {
        ...
        if countries.count == 1 || countries.count == 2{
            let bundle = "assets.bundle/"
